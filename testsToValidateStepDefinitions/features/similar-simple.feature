@similarsimplepage
Feature: similar simple page that extends the simple page object

  Background: I am on the simple page
    Given I am on the 'similar simple' page

  @similarsimplepage-react-link
  ...
  @similarsimplepage-heading-text
  Scenario: Testing .page file for xpath selectors
    Then I expect 'Similar stuff' to contain the text 'Something for the similar simple page object extending the simple page object'
    Then I expect 'main heading' to contain the text 'Simple page'
    And take a screenshot called 'simple page'

  @similarsimplepage-components
  ...
  @similarsimplepage-click-element-inside-element
