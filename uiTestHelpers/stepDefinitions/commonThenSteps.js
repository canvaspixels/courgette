...
const steps = [
  ...
  { matcher: "I expect the url 'URL' is opened in a new window", path: './checks/checkIsOpenedInNewWindow', code: 'urlnewwindow' },
  ...
  { matcher: "I expect the border colour of the 'LOCATOR' to be 'STRING'", path: './checks/checkElementBorderColour', code: 'bordercolour' },
